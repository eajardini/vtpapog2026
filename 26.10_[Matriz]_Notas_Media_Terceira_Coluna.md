Desenvolva um programa que efetue a leitura de 2 notas e calcule a média para 4 alunos (matriz 4x3). O programa deve:
  1. Solicitar 2 notas para cada aluno;  
  2. Calcular a média dos números e guardar o resultado na 3ª coluna, e    
  3. Imprimir (comando escreva) as notas para cada aluno e sua respectiva média.   
